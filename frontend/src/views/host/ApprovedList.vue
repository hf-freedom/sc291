        ...
        <div v-else class="request-list">
          ...
          >
            ...
            <div class="request-info">
              ...
              <div v-if="request.hostComment" class="info-row">
                <span class="label">审批备注:</span>
                <span>{{ request.hostComment }}</span>
              </div>
            </div>
          </div>
        </div>
...
const loadRequests = async () => {
  loading.value = true
  try {
    requests.value = await visitRequestStore.fetchRequestsByHost(authStore.user.id)
